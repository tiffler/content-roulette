...
const DATA = {
  ...
  firstNames: [
    ...
    'Anh', 'Anchana', 'Angelica', 'Anuwat', 'Araya', 'Agus', 'Bảo', 'Budi',
    'Chalee', 'Corazon', 'Dewi', 'Dian', 'Đức', 'Eko',
    'Hendra', 'Hoa', 'Huy', 'Indah', 'Jose', 'Juan', 'Katrina',
    'Linh', 'Lourdes', 'Mai', 'Malee', 'Maria', 'Minh', 'Nam',
    'Nattawut', 'Niran', 'Nittaya', 'Phương', 'Putri', 'Ramon',
    ...
    'Emilio', 'Enrique', 'Esperanza', 'Esteban', 'Fabián', 'Fernanda', 'Fernando',
    ...
    'Dimitri', 'Dominik', 'Dorothea', 'Éloïse', 'Einar', 'Eleni', 'Élodie',
    'Elke', 'Elsa', 'Émile', 'Emma', 'Enzo', 'Erik', 'Ernst',
    ...
    'Daniyar', 'Deniz', 'Derya', 'Elif', 'Emre', 'Esra', 'Gökçe', 'Fatma',
  ...
  lastNames: [
    ...
    'Aquino', 'Bautista', 'Buenaventura', 'Bùi', 'Charoenwong', 'Đào', 'Dela Cruz',
    'Đỗ', 'Espiritu', 'Gunawan', 'Hidayat', 'Hoàng', 'Kasem', 'Kusuma', 'Lazaro',
    'Lê', 'Lưu', 'Manalo', 'Ngô', 'Nguyễn', 'Phạm', 'Prasetyo', 'Santoso', 'Setiawan',
    'Srisawat', 'Thanh', 'Thongchai', 'Trần', 'Villanueva', 'Võ', 'Vương', 'Wibowo', 'Wijaya',
    ...
    'Sesay', 'Sithole', 'Traoré', 'Wambua', 'Yeboah', 'Zulu',

    // Latino / Hispanic Last Names
    'Acosta', 'Aguilar', 'Alvarado', 'Álvarez', 'Arce', 'Arias', 'Arredondo',
    'Barragán', 'Barrera', 'Benítez', 'Bermúdez', 'Blanco', 'Bravo', 'Caballero',
    'Cabrera', 'Calderón', 'Campos', 'Carrasco', 'Castillo', 'Castro', 'Cervantes',
    'Chávez', 'Contreras', 'Córdova', 'Coronado', 'Costa', 'Cortés', 'Cuevas',
    'Delgado', 'Domínguez', 'Duarte', 'Durán', 'Espinoza', 'Estrada', 'Fernández',
    'Figueroa', 'Flores', 'Franco', 'Fuentes', 'Gálvez', 'García', 'Garza', 'Gil',
    'Gómez', 'Guerrero', 'Gutiérrez', 'Heredia', 'Hernández', 'Herrera', 'Jiménez',
    ...
    'Pacheco', 'Palacios', 'Pereira', 'Pérez', 'Quiroga', 'Ramos', 'Rangel', 'Restrepo',
    'Reyes', 'Rivera', 'Rojas', 'Ruiz', 'Salazar', 'Salinas', 'Sandoval', 'Santos',
    'Serrano', 'Solís', 'Suárez', 'Tapia', 'Torres', 'Trujillo', 'Valencia', 'Vargas',
    'Vásquez', 'Vega', 'Velasco', 'Vera', 'Vicente', 'Villareal', 'Zamora',

    // European Last Names
    'Åberg', 'Adler', 'Åkesson', 'Almeida', 'Andersen', 'Anderssen', 'Andersson',
    ...
    'Müller', 'Nelson', 'Nielsen', 'Nissen', 'Novak', 'Nowak', 'O\'Connor', 'Olsen',
